...
async def on_ready():
  ...
  game = discord.Game("https://joebiden.gg/")
  await client.change_presence(status=discord.Status.online, activity=game)

# Bot Message when joining a new server
@client.event
async def on_guild_join(Guild):
  await Guild.system_channel.send('Hello! I am this server\'s very own, personal Joe Biden. My prefix is `joe`. You can run `joe help` to learn more. By default, I will respond to 1/100 messages. There will be an option to set custom response freqeuncy soon. Have a good uhh, you know, the thing!')
